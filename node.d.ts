...
declare namespace $ {
    const $milis_skills_mod_base: Omit<typeof $hyoo_crus_entity, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_entity, {
...
declare namespace $ {
    const $milis_skills_skill_base: Omit<typeof $hyoo_crus_entity, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_entity, {
...
declare namespace $ {
	...
	type $milis_skills_mod_input_textarea__hint_milis_skills_mod_input_1 = $mol_type_enforce<
		string
		,
		ReturnType< $milis_skills_mod_input_textarea['hint'] >
	>
	type $milis_skills_mod_input_textarea__mod_disabled_by_level_milis_skills_mod_input_2 = $mol_type_enforce<
		ReturnType< $milis_skills_mod_input['mod_disabled_by_level'] >
		,
		ReturnType< $milis_skills_mod_input_textarea['mod_disabled_by_level'] >
	>
	type $milis_skills_mod_input_textarea__value_milis_skills_mod_input_3 = $mol_type_enforce<
		ReturnType< $milis_skills_mod_input['mod_description'] >
		,
		ReturnType< $milis_skills_mod_input_textarea['value'] >
	>
	type $milis_skills_mod_input_textarea__enabled_milis_skills_mod_input_4 = $mol_type_enforce<
		ReturnType< $milis_skills_mod_input['skill_edit_checked'] >
		,
		ReturnType< $milis_skills_mod_input_textarea['enabled'] >
	>
	type $mol_button_minor__sub_milis_skills_mod_input_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_button_minor__click_milis_skills_mod_input_6 = $mol_type_enforce<
		ReturnType< $milis_skills_mod_input['mod_add'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_milis_skills_mod_input_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_button_minor__click_milis_skills_mod_input_8 = $mol_type_enforce<
		ReturnType< $milis_skills_mod_input['mod_remove'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_view__sub_milis_skills_mod_input_9 = $mol_type_enforce<
		ReturnType< $milis_skills_mod_input['mod_actions'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $milis_skills_mod_input extends $mol_view {
		mod_disabled_by_level( ): boolean
		mod_description( next?: any ): any
		Mod_textarea( ): $milis_skills_mod_input_textarea
		Add_icon( ): $mol_icon_plus
		mod_add( next?: any ): any
	...
	export class $milis_skills_mod_input_textarea extends $mol_textarea {
		mod_disabled_by_level( ): boolean
		attr( ): ({ 
			'mod_disabled_by_level': ReturnType< $milis_skills_mod_input_textarea['mod_disabled_by_level'] >,
...
declare namespace $.$$ {
    class $milis_skills_mod_input extends $.$milis_skills_mod_input {
        mod_actions(): readonly (any)[];
        mod_add(next?: any): void;
        mod_remove(next?: any): void;
...
declare namespace $ {
    const $milis_skills_person_base: Omit<typeof $hyoo_crus_home, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_home, {
        readonly Skill: (auto?: any) => {
            remote_list(next?: readonly $milis_skills_skill[] | undefined): readonly $milis_skills_skill[];
            remote_add(item: $milis_skills_skill): void;
            make(config: null | number | $hyoo_crus_rank_preset | $hyoo_crus_land): $milis_skills_skill;
            remote_make(config: $hyoo_crus_rank_preset): $milis_skills_skill;
            local_make(idea?: number): $milis_skills_skill;
            items(next?: readonly ((symbol & {
                $hyoo_crus_ref: symbol;
            }) | null)[] | undefined): readonly ((symbol & {
                $hyoo_crus_ref: symbol;
        ...
        readonly Level: (auto?: any) => $hyoo_crus_atom_real | null;
    }>) & {
        schema: {
            [x: string]: typeof $hyoo_crus_node;
        } & {
            ...
            readonly Level: typeof $hyoo_crus_atom_real;
        };
    };
    export class $milis_skills_person extends $milis_skills_person_base {
        skill_list(): readonly $milis_skills_skill[];
        level(next?: number): number;
        skill_make(): $milis_skills_skill;
        skill_remove(id: string): void;
    }
    export {};
}
...
declare namespace $ {
	...
	type __milis_skills_skill_card_1 = $mol_type_enforce<
		Parameters< $milis_skills_skill_card['name'] >[0]
		,
		Parameters< ReturnType< $milis_skills_skill_card['skill'] >['name'] >[0]
	>
	type __milis_skills_skill_card_2 = $mol_type_enforce<
		Parameters< $milis_skills_skill_card['type'] >[0]
		,
		Parameters< ReturnType< $milis_skills_skill_card['skill'] >['type'] >[0]
	>
	type $mol_string__hint_milis_skills_skill_card_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__value_milis_skills_skill_card_4 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_card['type'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__enabled_milis_skills_skill_card_5 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_card['skill_edit_checked'] >
		,
		ReturnType< $mol_string['enabled'] >
	>
	type $mol_string__hint_milis_skills_skill_card_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__value_milis_skills_skill_card_7 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_card['name'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__enabled_milis_skills_skill_card_8 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_card['skill_edit_checked'] >
		,
		ReturnType< $mol_string['enabled'] >
	>
	type $mol_list__rows_milis_skills_skill_card_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_text__text_milis_skills_skill_card_10 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_card['global_level_text'] >
		,
		ReturnType< $mol_text['text'] >
	>
	...
	type $mol_textarea__value_milis_skills_skill_card_15 = $mol_type_enforce<
		...
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_textarea__enabled_milis_skills_skill_card_16 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_card['skill_edit_checked'] >
		,
		ReturnType< $mol_textarea['enabled'] >
	>
	...
	>
	type $milis_skills_mod_input__skill_milis_skills_skill_card_18 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_card['skill'] >
		,
		ReturnType< $milis_skills_mod_input['skill'] >
	>
	...
	type $mol_list__rows_milis_skills_skill_card_20 = $mol_type_enforce<
		...
		ReturnType< $mol_list['rows'] >
	>
	type $mol_button_minor__title_milis_skills_skill_card_21 = $mol_type_enforce<
		string
		,
	...
	type $mol_list__rows_milis_skills_skill_card_23 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_card['skill_info_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	...
	>
	export class $milis_skills_skill_card extends $mol_card {
		name( next?: ReturnType< ReturnType< $milis_skills_skill_card['skill'] >['name'] > ): ReturnType< ReturnType< $milis_skills_skill_card['skill'] >['name'] >
		type( next?: ReturnType< ReturnType< $milis_skills_skill_card['skill'] >['type'] > ): ReturnType< ReturnType< $milis_skills_skill_card['skill'] >['type'] >
		skill_use( next?: any ): any
		...
		Remove_icon( ): $mol_icon_delete
		skill_remove( next?: any ): any
		Skill_remove( ): $mol_button_minor
		Skill_meta( ): $mol_row
		skill( ): $milis_skills_skill
		event( ): ({ 
			click( next?: ReturnType< $milis_skills_skill_card['skill_use'] > ): ReturnType< $milis_skills_skill_card['skill_use'] >,
		}) 
		content( ): readonly(any)[]
	}
...
//# sourceMappingURL=card.view.tree.d.ts.map
declare namespace $.$$ {
    class $milis_skills_skill_card extends $.$milis_skills_skill_card {
        person(): $milis_skills_person;
        skill_use(): void;
        level_up(next?: any): void;
        global_level_text(): string;
        skill_id(): string;
        skill_description(next?: string): string;
        skill_mod_list(): readonly (any)[];
...
declare namespace $ {
	...
	type __milis_skills_skill_page_1 = $mol_type_enforce<
		Parameters< $milis_skills_skill_page['level'] >[0]
		,
		Parameters< ReturnType< $milis_skills_skill_page['person'] >['level'] >[0]
	>
	type $mol_button_major__sub_milis_skills_skill_page_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_button_major__click_milis_skills_skill_page_3 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_page['add_skill'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_major__hint_milis_skills_skill_page_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['hint'] >
	>
	type $mol_text__text_milis_skills_skill_page_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_pick__trigger_content_milis_skills_skill_page_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_pick['trigger_content'] >
	>
	type $mol_pick__bubble_content_milis_skills_skill_page_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_pick['bubble_content'] >
	>
	type $mol_number__hint_milis_skills_skill_page_8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_number['hint'] >
	>
	type $mol_number__value_milis_skills_skill_page_9 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_page['level'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_number__Dec_milis_skills_skill_page_10 = $mol_type_enforce<
		any
		,
		ReturnType< $mol_number['Dec'] >
	>
	type $mol_number__Inc_milis_skills_skill_page_11 = $mol_type_enforce<
		any
		,
		ReturnType< $mol_number['Inc'] >
	>
	type $milis_skills_skill_card__skill_milis_skills_skill_page_12 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_page['get_skill'] >
		,
		ReturnType< $milis_skills_skill_card['skill'] >
	>
	type $mol_row__sub_milis_skills_skill_page_13 = $mol_type_enforce<
		ReturnType< $milis_skills_skill_page['skill_list'] >
		,
		ReturnType< $mol_row['sub'] >
	>
	export class $milis_skills_skill_page extends $mol_page {
		level( next?: ReturnType< ReturnType< $milis_skills_skill_page['person'] >['level'] > ): ReturnType< ReturnType< $milis_skills_skill_page['person'] >['level'] >
		Add_skill_icon( ): $mol_icon_plus_box_multiple
		add_skill( next?: any ): any
		Add_skill( ): $mol_button_major
		Tutorial_icon( ): $mol_icon_information_slab_circle_outline
		Info_text( ): $mol_text
		Tutorial_pick( ): $mol_pick
		Level( ): $mol_number
		get_skill( id: any): $milis_skills_skill
		Skill( id: any): $milis_skills_skill_card
...
//# sourceMappingURL=page.view.tree.d.ts.map
declare namespace $.$$ {
    class $milis_skills_skill_page extends $.$milis_skills_skill_page {
        person(): $milis_skills_person;
        skills(): readonly $milis_skills_skill[];
        skill_list(): readonly (any)[];
        get_skill(id: string): $milis_skills_skill;
        add_skill(next?: any): void;
    }
}
...
declare namespace $ {
	...
	type $mol_button_major__sub_milis_skills_game_page_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_select__option_label_default_milis_skills_game_page_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_select['option_label_default'] >
	>
	type $mol_select__options_milis_skills_game_page_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_select['options'] >
	>
	type $mol_select__option_label_default_milis_skills_game_page_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_select['option_label_default'] >
	>
	type $mol_select__options_milis_skills_game_page_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_select['options'] >
	>
	type $mol_list__rows_milis_skills_game_page_6 = $mol_type_enforce<
		ReturnType< $milis_skills_game_page['deck_list'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	export class $milis_skills_game_page extends $mol_page {
		Create_game_icon( ): $mol_icon_plus
		Create_game( ): $mol_button_major
		Select_game( ): $mol_select
		Select_deck( ): $mol_select
		deck_list( ): readonly(any)[]
		Deck_list( ): $mol_list
...
declare namespace $ {
	...
	type $mol_text__text_milis_skills_1 = $mol_type_enforce<
		ReturnType< $milis_skills['person_id'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_link_source__uri_milis_skills_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	export class $milis_skills extends $mol_book2_catalog {
		person_id( ): string
		Person_id( ): $mol_text
		Sources( ): $mol_link_source
		Skills_page( ): $milis_skills_skill_page
		Games_page( ): $milis_skills_game_page
		menu_title( ): string
		param( ): string
		menu_foot( ): readonly(any)[]
		spreads( ): ({ 
			'skills': ReturnType< $milis_skills['Skills_page'] >,
			'games': ReturnType< $milis_skills['Games_page'] >,
		}) 
	}
...
declare namespace $.$$ {
    class $milis_skills extends $.$milis_skills {
        person(): $milis_skills_person;
        person_id(): string;
    }
}
