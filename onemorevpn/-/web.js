...
var $;
(function ($) {
    class $milis_onemorevpn extends $mol_book2_catalog {
        param() {
            return "vpn";
        }
        menu_title() {
        ...
        Fetch_button() {
            ...
            obj.event_click = (val) => this.fetch_data(val);
            return obj;
        }
        User_first_name(id) {
            const obj = new this.$.$mol_text();
    ...
    __decorate([
        $mol_mem
    ], $milis_onemorevpn.prototype, "First_name", null);
    __decorate([
        $mol_mem
    ], $milis_onemorevpn.prototype, "Last_name", null);
    __decorate([
        $mol_mem
    ], $milis_onemorevpn.prototype, "Stat", null);
    __decorate([
        $mol_mem
    ], $milis_onemorevpn.prototype, "date", null);
    __decorate([
        $mol_mem
    ], $milis_onemorevpn.prototype, "Date", null);
    __decorate([
        $mol_mem
    ], $milis_onemorevpn.prototype, "fetch_data", null);
    __decorate([
        $mol_mem
    ], $milis_onemorevpn.prototype, "Fetch_button", null);
    __decorate([
        $mol_mem_key
    ], $milis_onemorevpn.prototype, "User_first_name", null);
    __decorate([
        $mol_mem_key
    ], $milis_onemorevpn.prototype, "row_id", null);
    __decorate([
        $mol_mem_key
    ], $milis_onemorevpn.prototype, "User_last_name", null);
    __decorate([
        $mol_mem_key
    ], $milis_onemorevpn.prototype, "Row", null);
    __decorate([
        $mol_mem
    ], $milis_onemorevpn.prototype, "Users", null);
    __decorate([
        $mol_mem
    ], $milis_onemorevpn.prototype, "SearchPage", null);
    $.$milis_onemorevpn = $milis_onemorevpn;
})($ || ($ = {}));
//milis/onemorevpn/-view.tree/onemorevpn.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $milis_onemorevpn extends $.$milis_onemorevpn {
            fetch_data() {
...
//milis/onemorevpn/onemorevpn.view.ts
