...
(function ($) {
    class $milis_helper extends $mol_list {
        ...
        Preview() {
            ...
            obj.event_click = (val) => this.prevStep(val);
        ...
        Next() {
            ...
            obj.event_click = (val) => this.nextStep(val);
    ...
    __decorate([
        $mol_mem
    ], $milis_helper.prototype, "Title", null);
    __decorate([
        $mol_mem
    ], $milis_helper.prototype, "Content", null);
    __decorate([
        $mol_mem
    ], $milis_helper.prototype, "prevStep", null);
    __decorate([
        $mol_mem
    ], $milis_helper.prototype, "Preview", null);
    __decorate([
        $mol_mem
    ], $milis_helper.prototype, "nextStep", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $milis_helper.prototype, "Buttons", null);
    $.$milis_helper = $milis_helper;
})($ || ($ = {}));
//milis/helper/-view.tree/helper.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $milis_helper.prototype, "show", null);
        __decorate([
            $mol_mem
        ], $milis_helper.prototype, "currentStep", null);
        $$.$milis_helper = $milis_helper;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//milis/helper/helper.view.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $mol_app_demo extends $mol_book2 {
        ...
        Menu2() {
            ...
            obj.item_tags = (id) => this.widget_tags(id);
        ...
        Menu() {
            ...
            obj.tags_selected = (next) => this.tags_selected(next);
    ...
    __decorate([
        $mol_mem
    ], $mol_app_demo.prototype, "Menu2", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $mol_app_demo.prototype, "tags_selected", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $mol_app_demo_menu2.prototype, "Body", null);
    __decorate([
        $mol_mem_key
    ], $mol_app_demo_menu2.prototype, "Item", null);
    __decorate([
        $mol_mem
    ], $mol_app_demo_menu2.prototype, "Tree", null);
    __decorate([
        $mol_mem
    ], $mol_app_demo_menu2.prototype, "List", null);
    $.$mol_app_demo_menu2 = $mol_app_demo_menu2;
    class $mol_app_demo_menu extends $mol_page {
        ...
        Tags() {
            ...
            obj.value = (val) => this.tags_selected(val);
    ...
    __decorate([
        $mol_mem
    ], $mol_app_demo_menu.prototype, "tags_selected", null);
    __decorate([
        $mol_mem
    ], $mol_app_demo_menu.prototype, "Tags", null);
    __decorate([
        $mol_mem
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $mol_app_demo extends $.$mol_app_demo {
            ...
            names_demo_filtered() {
                ...
                if (tags_selected.size > 0)
                    names = names.filter(name => this.widget_tags(name).some(tag => tags_selected.has(tag)));
                if (words.length !== 0) {
        ...
        __decorate([
            $mol_mem
        ], $mol_app_demo.prototype, "tags_dictionary", null);
        __decorate([
            $mol_mem
        ], $mol_app_demo.prototype, "tags_filtered", null);
        __decorate([
            $mol_mem
...
(function ($) {
    class $mol_icon_comment_question_outline extends $mol_icon {
        path() {
            return "M4,2C2.9,2 2,2.9 2,4V16C2,17.1 2.9,18 4,18H8V21C8,21.55 8.45,22 9,22H9.5V22C9.75,22 10,21.9 10.2,21.71L13.9,18H20C21.1,18 22,17.1 22,16V4C22,2.89 21.1,2 20,2H4M4,4H20V16H13.08L10,19.08V16H4V4M12.19,5.5C11.3,5.5 10.59,5.68 10.05,6.04C9.5,6.4 9.22,7 9.27,7.69C0.21,7.69 6.57,7.69 11.24,7.69C11.24,7.41 11.34,7.2 11.5,7.06C11.7,6.92 11.92,6.85 12.19,6.85C12.5,6.85 12.77,6.93 12.95,7.11C13.13,7.28 13.22,7.5 13.22,7.8C13.22,8.08 13.14,8.33 13,8.54C12.83,8.76 12.62,8.94 12.36,9.08C11.84,9.4 11.5,9.68 11.29,9.92C11.1,10.16 11,10.5 11,11H13C13,10.72 13.05,10.5 13.14,10.32C13.23,10.15 13.4,10 13.66,9.85C14.12,9.64 14.5,9.36 14.79,9C15.08,8.63 15.23,8.24 15.23,7.8C15.23,7.1 14.96,6.54 14.42,6.12C13.88,5.71 13.13,5.5 12.19,5.5M11,12V14H13V12H11Z";
        }
    }
    $.$mol_icon_comment_question_outline = $mol_icon_comment_question_outline;
})($ || ($ = {}));
//mol/icon/comment/question/outline/-view.tree/outline.view.tree.ts
;
"use strict";
var $;
(function ($) {
    class $milis_helper_toggle extends $mol_button_minor {
        hint() {
    ...
    __decorate([
        $mol_mem
    ], $milis_helper_toggle.prototype, "Icon", null);
    $.$milis_helper_toggle = $milis_helper_toggle;
})($ || ($ = {}));
//milis/helper/toggle/-view.tree/toggle.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $milis_helper_demo extends $mol_example_small {
        ...
        Toggle() {
            const obj = new this.$.$milis_helper_toggle();
            obj.event_click = (val) => this.toggleTutorial(val);
            return obj;
        }
        SomeButtonForHelp() {
            const obj = new this.$.$mol_button_major();
    ...
    __decorate([
        $mol_mem
    ], $milis_helper_demo.prototype, "toggleTutorial", null);
    __decorate([
        $mol_mem
    ], $milis_helper_demo.prototype, "Toggle", null);
    __decorate([
        $mol_mem
...
(function ($) {
    class $milis_hello extends $mol_view {
        ...
        Helper() {
            ...
            obj.endTour = (val) => this.toggleTutorial(val);
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $milis_hello.prototype, "name", null);
    __decorate([
        $mol_mem
    ], $milis_hello.prototype, "Name", null);
    __decorate([
        $mol_mem
    ], $milis_hello.prototype, "toggleTutorial", null);
    __decorate([
        $mol_mem
    ], $milis_hello.prototype, "ShowTutorial", null);
    __decorate([
        $mol_mem
    ], $milis_hello.prototype, "Helper", null);
    $.$milis_hello = $milis_hello;
})($ || ($ = {}));
//milis/hello/-view.tree/hello.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $milis_hello.prototype, "tutorial", null);
        $$.$milis_hello = $milis_hello;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//milis/hello/hello.view.ts
;
"use strict";
var $;
(function ($) {
    $mol_style_attach("milis/hello/hello.view.css", "/* Styling BEM-block by autogenerated attribute */\n[milis_hello] {\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tbox-shadow: 0 0 0 1px var(--mol_theme_line);\n}\n\n/* Styling BEM-element by autogenerated attribute */\n[milis_hello_name] {\n\tflex-grow: 0;\n\tmargin: 1rem;\n\twidth: 14rem;\n}\n");
})($ || ($ = {}));
//milis/hello/-css/hello.view.css.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $milis_helper_demo extends $.$milis_helper_demo {
            tutorialItems(items) {
                return items ?? mockItems;
            }
            tutorial(value) {
        ...
        __decorate([
            $mol_mem
        ], $milis_helper_demo.prototype, "tutorialItems", null);
        __decorate([
            $mol_mem
        ], $milis_helper_demo.prototype, "tutorial", null);
        __decorate([
